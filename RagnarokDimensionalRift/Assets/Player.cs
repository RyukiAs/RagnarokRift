...
public class Player : MonoBehaviour
{
    ...
    public void SummonGod()
    {
        ...
        if (num == 1)
        {
            ...
            God newGod = new God("Cthulhu", 1, godIcon, description);
        ...
        }else if (num == 2)
        {
            ...
            // Create a new god with a specified icon
            God newGod = new God("Zeus", 1, godIcon, description);
            gameController.allSummonedGods.Add(newGod);
        ...
        }else if (num == 3)
        {
            ...
            // Create a new god with a specified icon
            God newGod = new God("Dionysus", 1, godIcon, description);
            gameController.allSummonedGods.Add(newGod);
        ...
        }else if (num == 4)
        {
            ...
            // Create a new god with a specified icon
            God newGod = new God("Neptune", 1, godIcon, description);
            gameController.allSummonedGods.Add(newGod);
        ...
        }else if (num == 5)
        {
            ...
            // Create a new god with a specified icon
            God newGod = new God("Shiva", 1, godIcon, description);
            gameController.allSummonedGods.Add(newGod);
        ...
        }else if (num == 6)
        {
            ...
            // Create a new god with a specified icon
            God newGod = new God("Baba Yaga", 1, godIcon, description);
            gameController.allSummonedGods.Add(newGod);
        ...
        }else if (num == 7)
        {
            ...
            // Create a new god with a specified icon
            God newGod = new God("Thor", 1, godIcon, description);
            gameController.allSummonedGods.Add(newGod);
        ...
        }else if (num == 8)
        {
            ...
            // Create a new god with a specified icon
            God newGod = new God("Amaterasu", 1, godIcon, description);
            gameController.allSummonedGods.Add(newGod);
        ...
        }else if (num == 9)
        {
            ...
            string description = "Beelzebub - Beelzebub is commonly known as a demonic figure in Christian " +
                ...
                "\"Lord of the Flies.\"";
            // Create a new god with a specified icon
            God newGod = new God("Beelzebub", 1, godIcon, description);
            gameController.allSummonedGods.Add(newGod);
        ...
        }else if (num == 10)
        {
            ...
            // Create a new god with a specified icon
            God newGod = new God("Typhon", 1, godIcon, description);
            gameController.allSummonedGods.Add(newGod);
        ...
        }else 
        {
            ...
            string description = "Boogeyman - The Boogeyman's appearance is often left deliberately vague and " +
                ...
                "different cultures.";
            // Create a new god with a specified icon
            God newGod = new God("Boogeyman", 1, godIcon, description);
            gameController.allSummonedGods.Add(newGod);
        }
